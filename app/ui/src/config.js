...
export const CONFIG = {
  ...
  // Optional: int8-Encoder aus separater Quelle (Primaerquelle fuehrt nur int4).
  VITE_MODEL_ENCODER_REPO: runtime.VITE_MODEL_ENCODER_REPO ?? import.meta.env.VITE_MODEL_ENCODER_REPO,
