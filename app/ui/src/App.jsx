...
const STR = {
  de: {
    ...
    canaryHint: 'Canary 180M Flash (en/de/es/fr, int8, 213 MB): Encoder ~6× schneller als Parakeet, Decoder läuft Token für Token. Nur Transkription — Übersetzung wird nicht angeboten. Nach dem Umschalten neu laden.',
  ...
  en: {
    ...
    canaryHint: 'Canary 180M Flash (en/de/es/fr, int8, 213 MB): encoder ~6× faster than Parakeet, decoder runs token by token. Transcription only — no translation. Reload after switching.',
              ...
              <button className="pt-btn ghost" onClick={async () => {
                ...
                const report = {
                  ...
                  env: {
                    ...
                    canaryQuant: modelFamily === 'canary' ? 'int8' : null,
